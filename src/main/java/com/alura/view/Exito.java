...
public class Exito extends JDialog {
	 ...
	 */
	public Exito() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Exito.class.getResource("/2/aH-40px.png")));
		...
		contentPanel.setLayout(null);
		{
			...
			lblNewLabel.setIcon(new ImageIcon(Exito.class.getResource("/2/Ha-100px.png")));
