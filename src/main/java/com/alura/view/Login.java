...
public class Login extends JFrame {
	...
	public Login() {
		...
		imgHotel.setIcon(new ImageIcon("src/main/java/com/alura/imagenes/img-hotel-login-.png"));
		...
		lblNewLabel_1.setIcon(new ImageIcon("src/main/java/com/alura/imagenes/lOGO-50PX.png"));
